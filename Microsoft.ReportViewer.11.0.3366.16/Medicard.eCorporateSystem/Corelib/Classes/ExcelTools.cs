    ...
    public class ExcelTools
    {
        ...
        public static byte[] NewApplicationExcelDownload(string accountCode)
        {
            ...
            using (var package = new ExcelPackage(new FileInfo(targetPath)))
            {
                ...
                worksheet.Column(11).Style.Locked = true;

                worksheet.Cells[1, 1].Value = Guid.NewGuid();

                #region -- Date Validation --

                CellDateValidation(worksheet, "J3:J1048576", DateTime.UtcNow.AddYears(-1000));
                CellDateValidation(worksheet, "M3:M1048576", DateTime.UtcNow.AddYears(-1000));
                CellDateValidation(worksheet, "N3:N1048576", DateTime.UtcNow.AddYears(-1000));
                ...
                for (var currentRow = 3; currentRow <= 1000; currentRow++)
                {
                    worksheet.Cells[currentRow, 11].Formula = string.Format("IF(ISBLANK(J{0}), \"\",  IFERROR(DATEDIF(J{0},TODAY(),\"Y\"), \"\"))", currentRow);
                }

                CellIntegerValidation(worksheet, "R3:R1048576", 0);
                ...
                var validation1 = worksheet.DataValidations.AddListValidation("P3:P1048576");
                ...
                var validation3 = worksheet.DataValidations.AddListValidation("S3:S1048576");
                // set validation properties
                ...
                var validation4 = worksheet.DataValidations.AddListValidation("T3:T1048576");
                // set validation properties
                ...
                CellDropDownValidation(worksheet, "I3:I1048576", secondOptions);
                ...
                CellDropDownValidation(worksheet, "L3:L1048576", nextOption);

                #endregion

                #region -- Text Length Validation --

                CellTextLengthValidation(worksheet, "A3:A1048576", 64);
                CellTextLengthValidation(worksheet, "B3:B1048576", 64);
                CellTextLengthValidation(worksheet, "C3:C1048576", 64);
                CellTextLengthValidation(worksheet, "D3:D1048576", 64);
                CellTextLengthValidation(worksheet, "E3:E1048576", 64);
                CellTextLengthValidation(worksheet, "F3:F1048576", 64);
                CellTextLengthValidation(worksheet, "G3:G1048576", 64);
                CellTextLengthValidation(worksheet, "H3:H1048576", 64);
