    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Request.QueryString("u") Is Nothing Then
            Select Case Request.QueryString("t").ToString
                Case "0"
                    strRedirectPath = "~/emember/?u=" & EncryptDecrypt.EncryptDecrypt.Encrypt(u, key)
                Case "1"
                    strRedirectPath = String.Format("~/ecorporate/?t=1&u={0}&c={1}", u, Request.QueryString("c"))
                Case "2"
                    'strRedirectPath = "~/eaccount/?u=" & EncryptDecrypt.EncryptDecrypt.Encrypt(u, key)
                    strRedirectPath = String.Format("~/eaccount/?t=2&agnt={0}&c={1}&u={2}", Request.QueryString("agnt"), Request.QueryString("c"), EncryptDecrypt.EncryptDecrypt.Encrypt(u, key))
            End Select
