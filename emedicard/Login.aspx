        <%@ Page EnableEventValidation="false" Language="vb" AutoEventWireup="false" CodeBehind="Login.aspx.vb" Inherits="emedicard.Login" %>
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
			    ...
			    <div class="clearfix"></div>
							...
							<p class="center">
                                <asp:Button ID="btnLogin" runat="server" Text="Login" CausesValidation="false" CssClass="btn btn-primary" />							
		            ...
		            <div style="margin-left:auto; margin-right:auto; width:150px">                        
                        <!--- DO NOT EDIT - GlobalSign SSL Site Seal Code - DO NOT EDIT --->
                          <!--  <table width=130 border=0 cellspacing=0 cellpadding=0 title="CLICK TO VERIFY: This site uses a GlobalSign SSL Certificate to secure your personal information." ><tr><td><span id="ss_img_wrapper_130-65_image_en"><a href="https://www.globalsign.com/" target=_blank title="SSL"><img alt="SSL" border=0 id="ss_img" src="//seal.globalsign.com/SiteSeal/images/gs_noscript_130-65_en.gif"></a></span><script type="text/javascript" src="//seal.globalsign.com/SiteSeal/gs_image_130-65_en.js"></script><br /><a href="https://www.globalsign.com/" target=_blank  style="color:#000000; text-decoration:none; font:bold 8px arial; margin:0px; padding:0px;">Get GlobalSign SSL Certificates</a></td></tr></table> -->
                        <!--- DO NOT EDIT - GlobalSign SSL Site Seal Code - DO NOT EDIT --->
                    </div>
	</div><!--/.fluid-container-->
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
	...
	<!------ COOKIE BANNER ------->
<%--            <div class="row">
                <div id="cookie-consent" style="height: 100px; display: none; z-index: 10; background-color: lightgray; padding-top: 2.5em;">
                    <div class="container" style="vertical-align: middle !important; align-content: center !important;">
                        <p>
                        ...
                        <table width="100%">
                            <tr>
                                <td>
                                    We use cookies to make our website work better and improve your online experience. <br />
                                    By continuing to browse this website you hereby accept the use of cookies.
                                    For more info, see our <a href="https://www.medicardphils.com/privacy-notice" target="_blank">Privacy Policy</a>.
                                </td>
                                <td>
                                    <button class="btn btn-default" id="consent">Continue</button>
                                </td>
                            </tr>
                        </table>
                    </div>
         ...
         <!------ COOKIE BANNER ------->
<div id="cookie-consent" class="fixed-bottom p-3" style="background-color: lightgray">
    <div class="container text-center">
        ...
        <div class="row text-center">
            ...
            <div class="col-md-12"> <!-- Center align content -->
                <button class="btn btn-primary" id="consent">Continue</button>
            </div>
        </div>
    </div>
</div>
<!---------------------------->
	    ...
	    <br/>
			...
			<p>&nbsp;&nbsp;&copy; <asp:Label ID="lblYear" runat="server" Text="Label"></asp:Label> - eMedicard Portal | <a href="https://www.medicardphils.com/eula" target="_blank">End-User License Agreement</a> | <a href="https://www.medicardphils.com/privacy-notice" target="_blank">Privacy Policy</a></p>
  ...
  m = s.getElementsByTagName(o)[0]; a.async = 1; a.src = g; m.parentNode.insertBefore(a, m)
	...
	$(function () {
            ...
            function checkCookie() {
                var consent = getCookie("emedPPCookie");
                if (consent == "") {
                    $('#cookie-consent').removeClass("display");
                    $('#cookie-consent').slideDown('slow');
                }
            };

            $('#consent').on('click', function () {
                document.cookie = "emedPPCookie=Accepted; max-age=" + (3600 * 24) + "; path=/";
