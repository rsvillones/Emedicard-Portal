<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/emedicard.Master" CodeBehind="EditCorpUser.aspx.vb" Inherits="emedicard.EditCorpUser" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <tl:RadAjaxLoadingPanel ID="lp" runat="server" Skin="Default" BackgroundPosition="None" 
        ...
        <asp:Image runat="server" ID="loader" ImageAlign="Middle" ImageUrl="~/img/ajax-loaders/ajax-loader-7.gif" />
                ...
                <asp:HiddenField ID="hdnAgentUname" runat="server" />
					...
					<div class="box-content">
                        ...
                        <tl:RadMultiPage ID="RadMultiPage1" runat="server">
                            ...
                            <tl:RadPageView ID="RadPageView2" runat="server">
                                <legend>User Assigned Accounts</legend>
