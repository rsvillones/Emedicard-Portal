...
Public Class EditUser
    ...
    Protected Sub btn_Click(sender As Object, e As EventArgs) Handles btn.Click
        'Response.Redirect("~/ecorporate/UserManager.aspx?t=" & hdnType.Value & "&c=" & hdnCorporateCode.Value & "&u=" & hdnUsername.Value & "&uid=" & hdnUserID.Value)
        Response.Redirect("~/ecorporate/UserManager.aspx?t=" & hdnType.Value & "&c=" & hdnCorporateCode.Value & "&u=" & HttpUtility.UrlEncode(hdnUsername.Value) & "&uid=" & HttpUtility.UrlEncode(EncryptDecrypt.EncryptDecrypt.Encrypt(hdnUserID.Value, key)))
    End Sub

    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        Try

            Using eCorp = New eCorporateBLL(EncryptDecrypt.EncryptDecrypt.Decrypt(Request.QueryString("u"), key), Nothing, Request.QueryString("c"), EncryptDecrypt.EncryptDecrypt.Decrypt(Request.QueryString("uid"), key))
                With eCorp
