     ...
     <script type="text/javascript">
        ...
        ((evt.which) ? evt.which : 0));
         ...
         function consentChanged() {
             if ($("#btnSignUp").attr("disabled")) {
                 $("#btnSignUp").removeAttr("disabled");
                 $("#btnSignUp").removeClass("consent-notallowed");

                 $("#tConsentTooltip").removeClass("consent-tooltiptext");
                 $("#tConsentTooltip").attr("hidden", "hidden");
             }
             else {
                 $("#btnSignUp").attr("disabled", "disabled");
                 $("#btnSignUp").addClass("consent-notallowed");

                 $("#tConsentTooltip").addClass("consent-tooltiptext");
                 $("#tConsentTooltip").removeAttr("hidden");
             }
         }
				...
				<div class="well span5 center login-box">
					...
					<form class="form-horizontal" action="index.html" method="post">
						<fieldset style="text-align:left">
                                        ...
                                        <div class="col-lg-6 col-lg-offset-6">
                                            <div class="alert alert-info">
                                                <p>
                                                    ...
                                                    <br /><br />
                                                    <input type="checkbox" id="chkConsent" onchange="consentChanged();" />&nbsp; By ticking the box, we will consider that you agree to give your Consent to us.
                                                </p>
                                            </div>
			                ...
			                <div class="center span5 consent-tooltip">
                                <asp:Button ID="btnSignUp" runat="server" Text="Sign Up" 
                                    CssClass="btn btn-primary" disabled="disabled" />	

                                <div class="col-md-12" style="margin-top: 10px;">
                                    <span id="tConsentTooltip" class="consent-tooltiptext">&nbsp;Please tick the box to show that you read the consent and to continue the application.&nbsp;</span>
                                </div>
                            </div>
