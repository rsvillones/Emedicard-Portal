...
Public Class BenfitsExclusions
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            Else
                ...
                RadMultiPage1.PageViews(11).Visible = False
    ...
    Private Sub Load_ECS(ByVal sMemType As String)
        ...
        Try
            ...
            sbHTMLBuilder.Append("<tr><td class='col1'></td><td class='thcol2' >Amount in Percent(%)</td><td class='thcol3'>Dreaded Diseas Limit</td></tr>")
    ...
    Private Sub Load_PEC(ByVal sType As String)
        ...
        Try
            ...
            sbHTMLBuilder.Append("<tr><th class='PECthcol1' colspan='2'>Pre-Existing Conditions Coverage</th><th class='PECthcol3'>Constentability</th><th class='PECthcol4'>ME</th></tr>")
                ...
                For Each dr As DataRow In dtMAT.Rows
                    ...
                    If Not IsDBNull(dr("OPCS_PREPOST_NATAL_PRN")) Then
                        If Trim(dr("OPCS_PREPOST_NATAL_PRN")) <> "" Then
                            sbHTMLBuilder.Append("<font color='#4682b4'><strong>Prinicipal: </strong></font>" & dr("OPCS_PREPOST_NATAL_PRN"))
                        Else
                            sbHTMLBuilder.Append("<font color='#4682b4'><strong>Prinicipal: </strong></font><font color='red'>NONE</font>")
                        End If
                    ...
                    sbHTMLBuilder.Append("<tr><td class='col1'>Miscarieage/Abortion </td><td class='col2'>")
