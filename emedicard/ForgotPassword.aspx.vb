...
Public Class ForgotPassword
    ...
    Private Sub RetrieveEmemberAccount()
        ...
        Else
            ' send to email
            If Not bll.IsMemberActivated Then
                bll.GetMemberInformation(Trim(txtEmailAddress.Text))
                bll.SendActivationLink()
                lblAlert.Text = "Couldn't reset your password because your eMember account is not yet activated. We sent an activation link to your email, please click or paste the activation link to your web browser to activate your account."
                lblAlert.ForeColor = Drawing.Color.Red
                Exit Sub
    ...
    Protected Sub ddlAccType_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles ddlAccType.SelectedIndexChanged
