...
{
    public class UtilizationMedicalService
    {       
        #region -- Properties --
        ...
        [Column("MST_AMT")]
        public decimal MstAmount { get; set; }
        ...
        [Column("DCLASS_CODE")]
        public string DclassCode { get; set; }

        [Column("DCLASS_DESC")]
        public string DclassDescription { get; set; }
        ...
        [Column("DiagProc")]
        public decimal DiagProc { get; set; }

        [Column("Ultrasound")]
        public decimal UltraSound { get; set; }

        [Column("ARS_NO")]
        public string ArsNumber { get; set; }
