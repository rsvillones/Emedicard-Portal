...
namespace Corelib
{
    public class IdentityDataContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public DbSet<AccessibleGroup> AccessibleGroups { get; set; }
        ...
        public DbSet<MemberStatusProcessDate> MemberStatusProcessDates { get; set; }

        public DbSet<QuestionGroup> QuestionGroups { get; set; }

        public DbSet<MemberWrapper> MemberWrappers { get; set; }

        public DbSet<RenewalMemberWrapper> RenewalMemberWrappers { get; set; }

        public DbSet<EndorsementLog> EndorsementLogs { get; set; }

        public DbSet<DeclinedIdReplacement> DeclinedIdReplacements { get; set; }

        public DbSet<DeclinedAmendment> DeclinedAmendments { get; set; }
